AEM Anonymous Account Reset
===========================
This is a simple component that allows you to reset the anonymous password. 
the default password for the reset process can be configured in the OSGi bundle settings.
